...
// Every currency the dashboard can display. Mirrors the `Currency` union so a
// future currency addition fails to type-check here until the fixture is
// re-validated against it.
const DISPLAY_CURRENCIES: readonly Currency[] = ['EUR', 'CHF'];
